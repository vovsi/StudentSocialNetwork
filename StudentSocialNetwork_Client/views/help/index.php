...
<div class="accordion">
    <div id="profile" class="card">
        ...
        <div id="collapseProfile" class="collapse">
            <div class="card-body text-left">
                ...
                возможность добавлять текстовые записи (с возможностью прикрепить фото, видео, файлы, опрос...) к себе на 
    ...
    <div id="dialog" class="card">
        ...
        <div id="collapseDialog" class="collapse">
            <div class="card-body text-left">
                ...
                При первой авторизации список диалогов и бесед пуст. Чтобы начать общение с каким-либо пользователем, нужно
	...
	<div id="album" class="card">
        ...
        <div id="collapseFiles" class="collapse">
            <div class="card-body text-left">
                Вкладка <b>Файлы</b> содержит список файлов, которые вы можете загрузить. Это небольшое облачное хранилище
    ...
    <div id="videoLink" class="card">
        ...
        <div id="collapseVideoLink" class="collapse">
            <div class="card-body text-left">
                ...
                <img src="<?php echo Url::to('@web/resources/helpPage/video_link_help_1.png'); ?>" class="btn-rounded" style="width: 50%;"/><br/>
                2) Нажмите кнопку Поделиться на сайте YouTube и скопируйте часть ссылки которая выделена красным на
                скриншоте.
                <img src="<?php echo Url::to('@web/resources/helpPage/video_link_help_2.png'); ?>" class="btn-rounded" style="width: 50%;"/><br/>
    ...
    <div id="adminConnect" class="card">
        ...
        <div id="collapseAdminConnect" class="collapse">
            <div class="card-body text-left">
                Остались вопросы?<br/>
                Задайте их нашему <b>администратору</b> - <a href="<?php echo Url::to(['/42']); ?>">Алминистратор CNN</a> в сообщении.
            </div>
        </div>
    </div>
</div>
